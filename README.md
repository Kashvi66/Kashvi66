...
class Kashvi:
    ...
    def __init__(self):
        self.name = "Kashvi Javia"
        self.degree = "B.Tech Computer Science Engineering"
        self.university = "CHARUSAT University"
        ...
        self.goal = "Build meaningful technology 🚀"
...
Building robots that can sense, move and interact with the world.
...
<p>
<img src="https://skillicons.dev/icons?i=arduino,git,github,linux,ubuntu,vscode" />
</p>
...
An intelligent agricultural robot designed for:
